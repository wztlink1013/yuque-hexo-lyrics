...
class Doc {
   ...
   */
  async list({ namespace, data }) {
    assert(namespace, 'repo namespace or id is required');
    return this.client.request(`repos/${namespace}/docs`, {
      method: 'GET',
      data
    });
  }
  ...
  async get({ namespace, slug, data }) {
    ...
    return this.client.request(`repos/${namespace}/docs/${slug}`, {
      method: 'GET',
      data
    });
  }
  ...
  async update({ namespace, id, data }) {
    ...
    return this.client.request(`repos/${namespace}/docs/${id}`, {
      method: 'PUT',
      data
    });
  }
